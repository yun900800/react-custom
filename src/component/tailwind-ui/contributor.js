...
export default function Contributor() {
    ...
    return (
        <div className="flex flex-col bg-white rounded-lg my-2 px-6 py-8 ring shadow-xl ring-gray-900/5">
            ...
            <div className="mt-3 flex items-center justify-center -space-x-2 overflow-hidden">
            ...
            <div className="mt-3 text-sm font-medium flex items-center  justify-center">
